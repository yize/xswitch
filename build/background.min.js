...
var _, _2, _cmsInstance$get, _cmsInstance$get2;
...
var cmsInstance = new chrome_storage["a" /* ChromeStorageManager */]({
  useChromeStorageSyncFn: constants["Q" /* USE_CHROME_STORAGE_SYNC_FN */]
});
...
cmsInstance.get((_cmsInstance$get = {}, defineProperty_default()(_cmsInstance$get, constants["w" /* JSON_CONFIG */], {
  0: (_2 = {}, defineProperty_default()(_2, constants["I" /* PROXY_STORAGE_KEY */], []), defineProperty_default()(_2, constants["i" /* CORS_STORAGE */], []), _2)
}), defineProperty_default()(_cmsInstance$get, constants["b" /* ACTIVE_KEYS */], ['0']), _cmsInstance$get), function (result) {
...
cmsInstance.get((_cmsInstance$get2 = {}, defineProperty_default()(_cmsInstance$get2, constants["q" /* DISABLED */], enums["b" /* Enabled */].YES), defineProperty_default()(_cmsInstance$get2, constants["f" /* CLEAR_CACHE_ENABLED */], enums["b" /* Enabled */].YES), defineProperty_default()(_cmsInstance$get2, constants["h" /* CORS_ENABLED_STORAGE_KEY */], enums["b" /* Enabled */].YES), _cmsInstance$get2), function (result) {
...
chrome.storage.onChanged.addListener(function (changes) {
  ...
  cmsInstance.get(defineProperty_default()({}, constants["w" /* JSON_CONFIG */], {
...
function getConfigItems() {
  return new Promise(function (resolve) {
    ...
    csmInstance.get(defineProperty_default()({}, constants["P" /* TAB_LIST */], [{
      id: '0',
      name: 'Current',
      active: true
    }]), function (result) {
      resolve(result[constants["P" /* TAB_LIST */]]);
    });
  });
}
function setConfigItems(items) {
  if (true) {
    return new Promise(function (resolve) {
      ...
      csmInstance.set((_csmInstance$set2 = {}, defineProperty_default()(_csmInstance$set2, constants["P" /* TAB_LIST */], items.slice()), defineProperty_default()(_csmInstance$set2, constants["b" /* ACTIVE_KEYS */], items.map(function (item) {
        if (item.active) {
          return item.id;
        }
...
function removeUnusedItems() {
  ...
  csmInstance.get((_csmInstance$get7 = {}, defineProperty_default()(_csmInstance$get7, constants["v" /* JSONC_CONFIG */], {}), defineProperty_default()(_csmInstance$get7, constants["w" /* JSON_CONFIG */], {}), defineProperty_default()(_csmInstance$get7, constants["P" /* TAB_LIST */], [{
    id: '0',
    name: 'Current',
    active: true
    ...
    result[constants["P" /* TAB_LIST */]].forEach(function (tab) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Q", function() { return USE_CHROME_STORAGE_SYNC_FN; });
var REG = {
  TRIM_JSON: /(,+)([^a-z0-9["])/gi,
