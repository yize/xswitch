...
var arrayWithoutHoles = __webpack_require__("./node_modules/_@babel_runtime@7.5.5@@babel/runtime/helpers/arrayWithoutHoles.js");

var iterableToArray = __webpack_require__("./node_modules/_@babel_runtime@7.5.5@@babel/runtime/helpers/iterableToArray.js");

var nonIterableSpread = __webpack_require__("./node_modules/_@babel_runtime@7.5.5@@babel/runtime/helpers/nonIterableSpread.js");
...
// EXTERNAL MODULE: ./node_modules/_@babel_runtime@7.5.5@@babel/runtime/helpers/toConsumableArray.js
var toConsumableArray = __webpack_require__("./node_modules/_@babel_runtime@7.5.5@@babel/runtime/helpers/toConsumableArray.js");
var toConsumableArray_default = /*#__PURE__*/__webpack_require__.n(toConsumableArray);

// EXTERNAL MODULE: ./node_modules/_@babel_runtime@7.5.5@@babel/runtime/helpers/defineProperty.js
var defineProperty = __webpack_require__("./node_modules/_@babel_runtime@7.5.5@@babel/runtime/helpers/defineProperty.js");
...
// EXTERNAL MODULE: ./node_modules/_@babel_runtime@7.5.5@@babel/runtime/helpers/classCallCheck.js
var classCallCheck = __webpack_require__("./node_modules/_@babel_runtime@7.5.5@@babel/runtime/helpers/classCallCheck.js");
var classCallCheck_default = /*#__PURE__*/__webpack_require__.n(classCallCheck);

// EXTERNAL MODULE: ./node_modules/_@babel_runtime@7.5.5@@babel/runtime/helpers/createClass.js
var createClass = __webpack_require__("./node_modules/_@babel_runtime@7.5.5@@babel/runtime/helpers/createClass.js");
...
var csmInstance = new chrome_storage["a" /* ChromeStorageManager */]({
  useChromeStorageSyncFn: constants["R" /* USE_CHROME_STORAGE_SYNC_FN */]
});
...
csmInstance.get((_csmInstance$get = {}, defineProperty_default()(_csmInstance$get, constants["w" /* JSON_CONFIG */], {
  ...
  if (result && result[constants["w" /* JSON_CONFIG */]]) {
    ...
    forward[constants["w" /* JSON_CONFIG */]] = background_objectSpread({}, config);
  } else {
...
chrome.storage.onChanged.addListener(function (changes) {
  ...
  csmInstance.get(defineProperty_default()({}, constants["w" /* JSON_CONFIG */], {
    ...
    if (result && result[constants["w" /* JSON_CONFIG */]]) {
      ...
      forward[constants["w" /* JSON_CONFIG */]] = background_objectSpread({}, _config);
    }
...
function JSONC2JSON(jsonc) {
  return stripJsonComments(jsonc).replace(constants["J" /* REG */].WHITESPACE, constants["s" /* EMPTY_STRING */]).replace(constants["J" /* REG */].TRIM_JSON, function ($0, $1, $2) {
    return $2;
  });
}
...
function checkAndSyncHistorialSyncStorageDataToLocal() {
  ...
  var historyStorageKeyOrObj = (_historyStorageKeyOrO = {}, defineProperty_default()(_historyStorageKeyOrO, constants["v" /* JSONC_CONFIG */], {
    0: ''
  }), defineProperty_default()(_historyStorageKeyOrO, constants["w" /* JSON_CONFIG */], {}), defineProperty_default()(_historyStorageKeyOrO, constants["Q" /* TAB_LIST */], [{
    id: '0',
    name: 'Current',
    active: true
  }]), defineProperty_default()(_historyStorageKeyOrO, constants["b" /* ACTIVE_KEYS */], ['0']), _historyStorageKeyOrO);

  var migaratedFlag = defineProperty_default()({}, constants["P" /* SYNC_STORAGE_DATA_HAS_BEEN_MIGARATED_TO_LOCAL */], {
    migarated: false
  ...
  csmInstance.get(migaratedFlag, function (result) {
    if (!result[constants["P" /* SYNC_STORAGE_DATA_HAS_BEEN_MIGARATED_TO_LOCAL */]].migarated) {
      chrome.storage.sync.get(historyStorageKeyOrObj, function (hisData) {
        var _stash;

        var stash = (_stash = {}, defineProperty_default()(_stash, constants["v" /* JSONC_CONFIG */], {}), defineProperty_default()(_stash, constants["w" /* JSON_CONFIG */], {}), _stash);
        hisData[constants["Q" /* TAB_LIST */]].forEach(function (tab) {
          stash[constants["v" /* JSONC_CONFIG */]][tab.id] = hisData[constants["v" /* JSONC_CONFIG */]][tab.id];
          stash[constants["w" /* JSON_CONFIG */]][tab.id] = hisData[constants["w" /* JSON_CONFIG */]][tab.id];
        });
        csmInstance.set(_objectSpread(defineProperty_default()({}, constants["P" /* SYNC_STORAGE_DATA_HAS_BEEN_MIGARATED_TO_LOCAL */], {
          migarated: true
        }), hisData, {}, stash));
      });
    } else {
...
function getConfig(editingConfigKey) {
  return new Promise(function (resolve) {
    ...
    csmInstance.get(defineProperty_default()({}, constants["v" /* JSONC_CONFIG */], {
      0: ''
    }), function (result) {
      if (typeof result[constants["v" /* JSONC_CONFIG */]] === 'string') {
        return resolve(result[constants["v" /* JSONC_CONFIG */]]);
      }

      resolve(result[constants["v" /* JSONC_CONFIG */]][editingConfigKey]);
    });
  });
}
...
function getConfigItems() {
  return new Promise(function (resolve) {
    ...
    csmInstance.get(defineProperty_default()({}, constants["Q" /* TAB_LIST */], [{
      id: '0',
      name: 'Current',
      active: true
    }]), function (result) {
      resolve(result[constants["Q" /* TAB_LIST */]]);
    });
  });
}
function setConfigItems(items) {
  if (true) {
    return new Promise(function (resolve) {
      ...
      csmInstance.set((_csmInstance$set2 = {}, defineProperty_default()(_csmInstance$set2, constants["Q" /* TAB_LIST */], items.slice()), defineProperty_default()(_csmInstance$set2, constants["b" /* ACTIVE_KEYS */], items.map(function (item) {
        if (item.active) {
          return item.id;
        }
...
function saveConfig(jsonc, editingConfigKey) {
  ...
  if (true) {
    return new Promise(function (resolve) {
      ...
      csmInstance.get((_csmInstance$get5 = {}, defineProperty_default()(_csmInstance$get5, constants["v" /* JSONC_CONFIG */], {}), defineProperty_default()(_csmInstance$get5, constants["w" /* JSON_CONFIG */], {}), _csmInstance$get5), function (result) {
        // migrate
        if (typeof result[constants["v" /* JSONC_CONFIG */]] === 'string') {
          result[constants["v" /* JSONC_CONFIG */]] = {};
          result[constants["w" /* JSON_CONFIG */]] = {};
        }

        result[constants["v" /* JSONC_CONFIG */]][editingConfigKey] = jsonc;
        JSON_Parse(json, function (error, parsedJSON) {
          if (!error) {
            result[constants["w" /* JSON_CONFIG */]][editingConfigKey] = parsedJSON;
            return;
          }

          result[constants["w" /* JSON_CONFIG */]][editingConfigKey] = '';
        });
...
function removeUnusedItems() {
  ...
  csmInstance.get((_csmInstance$get7 = {}, defineProperty_default()(_csmInstance$get7, constants["v" /* JSONC_CONFIG */], {}), defineProperty_default()(_csmInstance$get7, constants["w" /* JSON_CONFIG */], {}), defineProperty_default()(_csmInstance$get7, constants["Q" /* TAB_LIST */], [{
    id: '0',
    name: 'Current',
    active: true
    ...
    var stash = (_stash2 = {}, defineProperty_default()(_stash2, constants["v" /* JSONC_CONFIG */], {}), defineProperty_default()(_stash2, constants["w" /* JSON_CONFIG */], {}), _stash2);
    result[constants["Q" /* TAB_LIST */]].forEach(function (tab) {
      stash[constants["v" /* JSONC_CONFIG */]][tab.id] = result[constants["v" /* JSONC_CONFIG */]][tab.id];
      stash[constants["w" /* JSON_CONFIG */]][tab.id] = result[constants["w" /* JSON_CONFIG */]][tab.id];
    });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Q", function() { return TAB_LIST; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "R", function() { return USE_CHROME_STORAGE_SYNC_FN; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "P", function() { return SYNC_STORAGE_DATA_HAS_BEEN_MIGARATED_TO_LOCAL; });
var REG = {
  TRIM_JSON: /(,+)([^a-z0-9["])/gi,
